...
import BettingContract from '../../noTruffleContracts/Betting.json'
...
let minBet = 0;
   ...
   if (this.scheduleStringKey in this.props.contracts["BetSwap"].showSchedString) {
    ...
    console.log("scheding", netLiab[0]);
    const raw = '1eac3';
    const used = web3.hexToNumber('0x' + raw);
    console.log("used", used);
  //  const used2 = web3.hexToNumber(raw);
  //  console.log("hex", used2);
